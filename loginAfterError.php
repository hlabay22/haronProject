...
<div>
   ...
   <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    echo ("Email or Password Not Valid! - Please Try Again.");
    ...
    if(isset($_POST['submitTraveller'])){
      ...
      <div class="jumbotron">
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item">
              <a class="nav-link " data-toggle="tab" href="#home">Traveller Login</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" data-toggle="tab" href="#profile">Local Guide Login</a>
            </li>
